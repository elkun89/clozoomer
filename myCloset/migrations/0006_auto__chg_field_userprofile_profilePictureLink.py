...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.profilePictureLink'
        db.alter_column('myCloset_userprofile', 'profilePictureLink', self.gf('django.db.models.fields.files.ImageField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'UserProfile.profilePictureLink'
        db.alter_column('myCloset_userprofile', 'profilePictureLink', self.gf('django.db.models.fields.CharField')(max_length=200))
