...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserProfile.profielPictureLink'
        db.delete_column('myCloset_userprofile', 'profielPictureLink')
    ...
    def backwards(self, orm):
        # Adding field 'UserProfile.profielPictureLink'
        db.add_column('myCloset_userprofile', 'profielPictureLink',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)
    ...
    models = {
        ...
        'myCloset.userprofile': {
            ...
            'profilePictureLink': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
