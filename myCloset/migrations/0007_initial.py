...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('myCloset_userprofile', (
            ...
            ('firstname', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('lastname', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=200, blank=True)),
            ('profilePictureLink', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
        ))
