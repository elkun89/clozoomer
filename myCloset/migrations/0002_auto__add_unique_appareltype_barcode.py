...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'ApparelType', fields ['barcode']
        db.create_unique('myCloset_appareltype', ['barcode'])


    def backwards(self, orm):
        # Removing unique constraint on 'ApparelType', fields ['barcode']
        db.delete_unique('myCloset_appareltype', ['barcode'])
