...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('myCloset_userprofile', 'username',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)

        # Adding field 'UserProfile.firstname'
        db.add_column('myCloset_userprofile', 'firstname',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.lastname'
        db.add_column('myCloset_userprofile', 'lastname',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.email'
        db.add_column('myCloset_userprofile', 'email',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('myCloset_userprofile', 'username')

        # Deleting field 'UserProfile.firstname'
        db.delete_column('myCloset_userprofile', 'firstname')

        # Deleting field 'UserProfile.lastname'
        db.delete_column('myCloset_userprofile', 'lastname')

        # Deleting field 'UserProfile.email'
        db.delete_column('myCloset_userprofile', 'email')
